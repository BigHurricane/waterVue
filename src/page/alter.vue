  ...
  <div>
    ...
    <div class="confirm" v-if="isShows">
      <div class="tipContainer">
          <div class="del" @click="alteraddr"><img src="../assets/del.png"/></div>
        <span class="tip--title">提示</span>
        <span class="tip--content">收货地址保存成功</span>
          <app-button @click.native="alteraddr" class="sure_btn" >确定</app-button>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    alteraddr() {
       this.$request.alterAddr({
         receiver: this.userName,
         location: this.address,
         details: this.detailAddress,
         phoneNumber: this.phoneNumber,
         addrid: this.$route.query.Data._id,
       })
         .then((data) => {
           console.log(data);
